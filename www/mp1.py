...
preference_data = {
    "items": [
        {
            "title": "Sessão de Terapia - Rafael Kessie",
            "quantity": 1,
            "unit_price": 60.00,
            "currency_id": "BRL"
        }
    ...
    "back_urls": {
        "success": "http://127.0.0.1:5500/sucesso.html",#URL de pagamento conluido
        "failure": "http://127.0.0.1:5500/falha.html",#URL de pagamento falho
        "pending": "https://www.sua-plataforma.com/pendente"#URL de pagamento pendente
    },
    "auto_return": "all",
